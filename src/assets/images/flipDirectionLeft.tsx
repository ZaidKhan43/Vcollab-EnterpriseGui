...
<path d="M7.54545 38L1 44.5455L7.54545 51.0909" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
<g opacity="0.5">
...
export default function FlipDirectionLeftIcon() {
  ...
  return (
      <FlipDirectionLeft viewBox="0 0 61 90"/>
  );
}
